                            ...
                            {password && (
                                ...
                                >
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span className={`text-xs font-medium ${passwordStrength.strength >= 4 ? 'text-green-400' : passwordStrength.strength >= 3 ? 'text-blue-400' : passwordStrength.strength >= 2 ? 'text-yellow-400' : 'text-red-400'}`}>
